...
export const metadata: Metadata = {
  title: "Mitolyn Complaints: What You Need to Know",
  description: "Stay informed about potential complaints regarding Mitolyn.",
  openGraph: {
    title: "Mitolyn Complaints: What You Need to Know",
    description: "Stay informed about potential complaints regarding Mitolyn.",
    url: "https://mitolyn-review-video.vercel.app/mitolyn-complaints-2026",
  },
  alternates: {
    canonical: "https://mitolyn-review-video.vercel.app/mitolyn-complaints-2026",
  }
};

export default function Page() {
  const copy = getPageCopy('mitolyn-complaints-2026');
