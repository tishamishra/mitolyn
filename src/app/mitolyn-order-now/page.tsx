...
export const metadata: Metadata = {
  title: "Order Mitolyn Now for Maximum Benefits!",
  description: "Don’t wait—order Mitolyn now and transform your health!",
  openGraph: {
    title: "Order Mitolyn Now for Maximum Benefits!",
    description: "Don’t wait—order Mitolyn now and transform your health!",
    url: "https://mitolyn-review-video.vercel.app/mitolyn-order-now",
  },
  alternates: {
    canonical: "https://mitolyn-review-video.vercel.app/mitolyn-order-now",
  }
};

export default function Page() {
  const copy = getPageCopy('mitolyn-order-now');
