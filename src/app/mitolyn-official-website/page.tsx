...
export const metadata: Metadata = {
  title: "Mitolyn Official Website 2026 - Claim Your Discount",
  description: "Looking for the Mitolyn official website? Watch this video before buying...",
  openGraph: {
    title: "Mitolyn Official Website 2026 - Claim Your Discount",
    description: "Looking for the Mitolyn official website? Watch this video before buying...",
    url: "https://mitolyn-review-video.vercel.app/mitolyn-official-website",
  },
  alternates: {
    canonical: "https://mitolyn-review-video.vercel.app/mitolyn-official-website",
  }
};

export default function Page() {
  const copy = getPageCopy('mitolyn-official-website');
