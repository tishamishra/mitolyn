...
export const metadata: Metadata = {
  title: "Mitolyn Results Timeline: What to Expect",
  description: "Find out when you can expect to see results from Mitolyn!",
  openGraph: {
    title: "Mitolyn Results Timeline: What to Expect",
    description: "Find out when you can expect to see results from Mitolyn!",
    url: "https://mitolyn-review-video.vercel.app/mitolyn-results-timeline",
  },
  alternates: {
    canonical: "https://mitolyn-review-video.vercel.app/mitolyn-results-timeline",
  }
};

export default function Page() {
  const copy = getPageCopy('mitolyn-results-timeline');
