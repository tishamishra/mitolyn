...
export const metadata: Metadata = {
  title: "Is Mitolyn Safe? Find Out Here!",
  description: "Learn about the safety and efficacy of Mitolyn for your health.",
  openGraph: {
    title: "Is Mitolyn Safe? Find Out Here!",
    description: "Learn about the safety and efficacy of Mitolyn for your health.",
    url: "https://mitolyn-review-video.vercel.app/is-mitolyn-safe",
  },
  alternates: {
    canonical: "https://mitolyn-review-video.vercel.app/is-mitolyn-safe",
  }
};

export default function Page() {
  const copy = getPageCopy('is-mitolyn-safe');
