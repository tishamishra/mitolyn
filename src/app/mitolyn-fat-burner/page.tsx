...
export const metadata: Metadata = {
  title: "Mitolyn: Your Ultimate Fat Burner!",
  description: "Discover how Mitolyn can help you on your fat-burning journey!",
  openGraph: {
    title: "Mitolyn: Your Ultimate Fat Burner!",
    description: "Discover how Mitolyn can help you on your fat-burning journey!",
    url: "https://mitolyn-review-video.vercel.app/mitolyn-fat-burner",
  },
  alternates: {
    canonical: "https://mitolyn-review-video.vercel.app/mitolyn-fat-burner",
  }
};

export default function Page() {
  const copy = getPageCopy('mitolyn-fat-burner');
