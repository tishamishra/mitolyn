...
export const metadata: Metadata = {
  title: "Start Your Mitolyn Trial Today!",
  description: "Experience the benefits of Mitolyn with our trial offer!",
  openGraph: {
    title: "Start Your Mitolyn Trial Today!",
    description: "Experience the benefits of Mitolyn with our trial offer!",
    url: "https://mitolyn-review-video.vercel.app/mitolyn-trial",
  },
  alternates: {
    canonical: "https://mitolyn-review-video.vercel.app/mitolyn-trial",
  }
};

export default function Page() {
  const copy = getPageCopy('mitolyn-trial');
