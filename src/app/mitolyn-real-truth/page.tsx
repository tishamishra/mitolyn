...
export const metadata: Metadata = {
  title: "The Real Truth About Mitolyn - What You Need to Know in 2026",
  description: "Uncover the real truth behind Mitolyn and its claims...",
  openGraph: {
    title: "The Real Truth About Mitolyn - What You Need to Know in 2026",
    description: "Uncover the real truth behind Mitolyn and its claims...",
    url: "https://mitolyn-review-video.vercel.app/mitolyn-real-truth",
  },
  alternates: {
    canonical: "https://mitolyn-review-video.vercel.app/mitolyn-real-truth",
  }
};

export default function Page() {
  const copy = getPageCopy('mitolyn-real-truth');
