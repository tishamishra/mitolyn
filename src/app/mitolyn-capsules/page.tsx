...
export const metadata: Metadata = {
  title: "Mitolyn Capsules: The Convenient Choice!",
  description: "Experience the benefits of Mitolyn in easy-to-take capsule form!",
  openGraph: {
    title: "Mitolyn Capsules: The Convenient Choice!",
    description: "Experience the benefits of Mitolyn in easy-to-take capsule form!",
    url: "https://mitolyn-review-video.vercel.app/mitolyn-capsules",
  },
  alternates: {
    canonical: "https://mitolyn-review-video.vercel.app/mitolyn-capsules",
  }
};

export default function Page() {
  const copy = getPageCopy('mitolyn-capsules');
